      ...
      <div className="community-link-cards">
        <button type="button" className="community-link-card" onClick={() => openUrl(REPO_URL)}>
          ...
          <div className="community-link-card__body">
            <span className="community-link-card__title">XnneHangLab / XnneHangLab</span>
            <span className="community-link-card__desc">github.com/XnneHangLab/XnneHangLab</span>
          </div>
