...
const PLUGIN_CONFIG_FIELDS: Record<string, PluginField[]> = {
  wikimem: [
    ...
    { key: 'search_limit', type: 'number', description: '每轮召回的最大命中条数', defaultValue: 10 },
    { key: 'budget_tokens', type: 'number', description: '每轮注入记忆的 token 预算', defaultValue: 800 },
    { key: 'extraction_base_url', type: 'text', description: '抽取 LLM base_url；留空 = 继承 chat 模型配置', defaultValue: '' },
    { key: 'extraction_model', type: 'text', description: '抽取 LLM 模型名；留空 = 继承 chat 模型配置', defaultValue: '' },
    { key: 'extraction_api_key', type: 'text', description: '抽取 LLM API key；留空 = 继承 chat 模型配置', defaultValue: '' },
    { key: 'embedding_base_url', type: 'text', description: 'embedding 端点 base_url；留空 = 纯 BM25', defaultValue: '' },
    { key: 'embedding_model', type: 'text', description: 'embedding 模型名；留空 = 纯 BM25', defaultValue: '' },
    { key: 'embedding_api_key', type: 'text', description: 'embedding API key（可选）', defaultValue: '' },
  ],
  mood_chat: [
